...
public class Datos {
  ...
  private void crearPasajero(){
   // Agrega algunos pasajeros de ejemplo
    listaPasajeros.add(new Pasajero("ID12345","Pedro Perez Salazar","12345678A","PAS23467hkj","695758586","lennycarl@gmail.com","Bizkaia", "España","68892346","14/03/1995");

    modificarPasajero(listaPasajeros);
